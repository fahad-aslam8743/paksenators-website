...
import { PhotoCollectionsView } from './views/PhotoCollectionsView';
...
const MainContent: React.FC = () => {
  ...
  const renderView = () => {
    switch (currentView) {
      ...
      case 'photo-collections': return <PhotoCollectionsView />;
      case 'videos': 
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 text-slate-900 font-sans antialiased">
      ...
      <main className="flex-grow">
        {/* Keyed by currentView so switching pages after a crash mounts a
         * fresh boundary instead of staying stuck on the error state. A
         * crash here can never take out the Header/Footer/nav above and
         * below it. */}
        <ErrorBoundary key={currentView} label="This page">
          {renderView()}
        </ErrorBoundary>
      </main>
