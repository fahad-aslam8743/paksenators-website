...
export const MemberPortalView: React.FC = () => {
  ...
  // Clicking the digital membership card opens the same official
  // front/back certificate (with the same Download PDF button) that the
  // admin sees in the Membership CMS — shared via CertificateModal so the
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-5 space-y-4">
          ...
          <div
            ...
            title="Click to view your official certificate"
            className="bg-gradient-to-br from-emerald-900 via-emerald-950 to-slate-900 text-white rounded-2xl p-6 border-2 border-amber-400 shadow-2xl space-y-6 relative overflow-hidden cursor-pointer hover:border-amber-300 transition-colors"
          >
            ...
            <div className="flex gap-4 items-center">
              <img
                ...
                className="w-20 h-24 rounded-lg object-cover object-[center_15%] border-2 border-amber-400"
              />
          ...
          <p className="text-[11px] text-slate-500 text-center">Tap the card above to view and download your official certificate.</p>
      ...
      {showCertificate && (
        <CertificateModal
          senator={{
            ...
            parliamentaryRole: profile?.parliamentaryRole,
