...
// No demo/sample videos ship with this app anymore — the video gallery
// starts empty and is populated entirely by real uploads (via the admin
// panel, which streams straight to YouTube) or by the YouTube channel
// sync. See server.ts / server/youtube.ts.
...
export const initialMediaItems: MediaItem[] = [
  {
    ...
    type: 'image',
    url: '/images/irfan_mateen_original_1786443966305.jpg',
    fileSize: '1.2 MB',
  ...
  },
  {
    ...
    type: 'image',
    url: '/images/haroon_mateen_president_1786445857055.jpg',
    fileSize: '1.5 MB',
  ...
  },
  {
    ...
    type: 'logo',
    url: '/images/ysp_official_logo_1786441197850.jpg',
    fileSize: '350 KB',
