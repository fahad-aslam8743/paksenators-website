...
export const FounderPresidentCMS: React.FC = () => {
  ...
  const handleDeleteFounderPhoto = async () => {
    ...
    setFounder(updated);
    try {
      if (founder.photoStoragePath) {
        try {
          await deleteImageFromFirebase(founder.photoStoragePath);
        } catch (err) {
  ...
  const handleDeletePresidentPhoto = async () => {
    ...
    try {
      if (president.photoStoragePath) {
        try {
          await deleteImageFromFirebase(president.photoStoragePath);
        } catch (err) {
          console.warn('Storage delete warning:', err);
        }
      }
  ...
  const handleDeleteVPPhoto = async () => {
    ...
    try {
      if (vicePresident.photoStoragePath) {
        try {
          await deleteImageFromFirebase(vicePresident.photoStoragePath);
        } catch (err) {
          console.warn('Storage delete warning:', err);
        }
      }
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-4 p-5 bg-slate-50 border border-slate-200 rounded-2xl space-y-4">
              ...
              <div className="relative group">
                <img
                  src={founder.photoUrl || '/src/assets/images/ysp_official_logo_1786441197850.jpg'}
                  alt={founder.name}
                  className="w-full h-64 object-cover object-top rounded-xl border-2 border-slate-200 shadow-md bg-white"
                />
                {founder.photoUrl && (
                  <button
                    type="button"
              ...
              <ImageUploader
                ...
                onUploadSuccess={async (url, path) => {
                  ...
                  try {
                    ...
                    showNotification('Founder Chairman photo updated.', 'info');
                  }
                }}
              />
            </div>
        ...
        <form onSubmit={handleSavePresident} className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-4 p-5 bg-slate-50 border border-slate-200 rounded-2xl space-y-4">
              ...
              <div className="relative group">
                <img
                  src={president.photoUrl || '/src/assets/images/ysp_official_logo_1786441197850.jpg'}
                  alt={president.name}
                  className="w-full h-64 object-cover object-top rounded-xl border-2 border-slate-200 shadow-md bg-white"
                />
                {president.photoUrl && (
              ...
              <ImageUploader
                ...
                onUploadSuccess={async (url, path) => {
                  ...
                  try {
                    ...
                    showNotification('President photo updated.', 'info');
                  }
                }}
              />
            </div>
        ...
        <form onSubmit={handleSaveVicePresident} className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-4 p-5 bg-slate-50 border border-slate-200 rounded-2xl space-y-4">
              ...
              <div className="relative group">
                <img
                  src={vicePresident.photoUrl || '/src/assets/images/ysp_official_logo_1786441197850.jpg'}
              ...
              <ImageUploader
                ...
                onUploadSuccess={async (url, path) => {
                  ...
                  try {
                    ...
                    showNotification('Vice President photo updated.', 'info');
                  }
                }}
              />
            </div>
